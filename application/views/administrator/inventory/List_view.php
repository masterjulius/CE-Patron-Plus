		...
		<div class="col s12">
			...
			?>
					<tr>
						...
						<td><a href="<?= site_url( $this->uri->slash_rsegment(1) . $this->uri->slash_rsegment(2) . 'view/' . $item_id ); ?>">View</a> | <a href="<?= site_url( $this->uri->slash_rsegment(1) . $this->uri->slash_rsegment(2) . 'edit/' . $item_id ); ?>" class="teal-text">Edit</a></td>
					</tr>
			<?php		
				endforeach;
			?>	
